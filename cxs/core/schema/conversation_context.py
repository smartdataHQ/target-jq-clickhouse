...
if __name__ == "__main__":
    some = ConversationContext(**{"products_in_scope": [], "product_interests": [], "focus_product": None, "product_searches": [], "last_product_search": {}, "interests": [], "entity_sentiment": [], "occasions": [], "personal_details": [], "flags": [], "product_recommendations": []})
    print(some.model_json_schema())
